...
function Header() {
  ...
  return (
    <header className="glass-chrome depth-surface sticky top-0 z-40 flex shrink-0 items-center gap-3 border-b px-4 py-3 text-[hsl(var(--foreground))]">
      ...
      {menuOpen && (
        <div className="absolute right-3 top-14 z-30 w-48 overflow-hidden rounded-2xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] p-1.5 shadow-2xl animate-rise-in">
...
function AdminPanel() {
  ...
  const renderRequest = (request: AdminRequest, type: AdminRequestType) => {
    ...
    return <article key={actionKeyForRequest} className="depth-card rounded-2xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] p-4">
  ...
  return <main className="game-grain depth-stage mx-auto flex h-[100dvh] max-w-[520px] flex-col overflow-hidden overscroll-none bg-[hsl(var(--background))] text-[hsl(var(--foreground))] shadow-2xl">
    ...
    <div className="min-h-0 flex-1 overflow-y-auto px-3 pb-6 pt-5">
      <div className="mb-5 flex items-center justify-between gap-3">
        ...
        <button type="button" data-testid="button-admin-back" onClick={() => setLocation('/')} className="depth-action rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-2 text-xs font-bold text-[hsl(var(--foreground)/.8)]">← BACK</button>
      </div>
      ...
      {status === 'ready' && requests && <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-2 rounded-2xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] p-1">
        ...
        {gameSettings && <section className="depth-card rounded-2xl border border-[hsl(var(--accent)/.35)] bg-[hsl(var(--accent)/.08)] p-4">
          ...
          <label className="mb-3 block text-xs font-bold text-[hsl(var(--foreground)/.85)]"><span>የSupport Team username</span><input type="text" value={gameSettings.supportUsername} onChange={(event) => updateSetting('supportUsername', event.target.value)} placeholder="@SupportUsername" className="mt-1 w-full rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-2.5 font-mono text-sm font-bold text-[hsl(var(--foreground))] outline-none" /></label>
          <div className="grid grid-cols-2 gap-3">
            {[['registrationBonus', 'የሬጂስተር ቦነስ', 'ETB', '0', '100000', '0.01'], ['inviteBonus', 'የኢንቫይት ቦነስ', 'ETB', '0', '100000', '0.01'], ['depositBonusPercentage', 'የዲፖዚት ቦነስ', '%', '0', '100', '0.01'], ['mainPrizePercentage', 'ዋና ጨዋታ ፕራይዝ', '%', '0', '100', '0.01'], ['leaderboardPoolPercentage', 'ሊደርቦርድ ፕራይዝ ፑል', '%', '0', '100', '0.01'], ['leaderboardFirstPercentage', 'ሊደርቦርድ 1ኛ', '%', '0', '100', '0.01'], ['leaderboardSecondPercentage', 'ሊደርቦርድ 2ኛ', '%', '0', '100', '0.01'], ['leaderboardThirdPercentage', 'ሊደርቦርድ 3ኛ', '%', '0', '100', '0.01'], ['maxCardsPerPlayer', 'ከፍተኛ የካርድ መያዣ', 'ካርድ', '1', '500', '1'], ['leaderboardCardPurchasePoints', 'ካርድ ሲገዛ ነጥብ', 'ነጥብ', '-100', '100', '1'], ['leaderboardCardReleasePoints', 'ካርድ ሲለቀቅ ነጥብ', 'ነጥብ', '-100', '100', '1'], ['leaderboardWinPoints', 'ቢንጎ ሲያሸንፍ ነጥብ', 'ነጥብ', '-100', '100', '1']].map(([field, label, suffix, min, max, step]) => <label key={field} className="block text-xs font-bold text-[hsl(var(--foreground)/.85)]">
              <span>{label}</span>
              <div className="mt-1 flex items-center rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3">
        ...
        <section className="depth-card rounded-2xl border border-[hsl(var(--primary)/.35)] bg-[hsl(var(--primary)/.08)] p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <input value={promoCode} onChange={(event) => setPromoCode(event.target.value)} placeholder="CODE2026" className="rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-3 text-sm font-bold uppercase text-[hsl(var(--foreground))] outline-none placeholder:text-[hsl(var(--muted-foreground))]" />
            <input type="number" min="0.01" step="0.01" value={promoReward} onChange={(event) => setPromoReward(event.target.value)} placeholder="Reward ETB" className="rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-3 text-sm font-bold text-[hsl(var(--foreground))] outline-none placeholder:text-[hsl(var(--muted-foreground))]" />
            <input type="number" min="1" step="1" value={promoLimit} onChange={(event) => setPromoLimit(event.target.value)} placeholder="Max uses (optional)" className="rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-3 text-sm font-bold text-[hsl(var(--foreground))] outline-none placeholder:text-[hsl(var(--muted-foreground))]" />
            <input type="datetime-local" value={promoExpiresAt} onChange={(event) => setPromoExpiresAt(event.target.value)} className="rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-3 text-xs font-bold text-[hsl(var(--foreground))] outline-none" />
          </div>
        ...
        {adminTab === 'users' && <section className="space-y-4">
          <input value={userSearch} onChange={(event) => setUserSearch(event.target.value)} placeholder="Search name, username, phone, Telegram ID..." className="w-full rounded-xl border border-[hsl(33_28%_82%)] bg-[hsl(var(--card))] px-3 py-3 text-sm text-[hsl(var(--foreground))] outline-none placeholder:text-[hsl(var(--muted-foreground))]" />
